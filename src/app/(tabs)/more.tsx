...
type Item = { title: string; subtitle: string; icon: IconSymbolName; href: Href; pro: boolean };

const ITEMS: Item[] = [
  {
    title: 'Deductions',
    subtitle: 'Lower your tax bill',
    icon: 'tag.fill',
    href: '/deductions',
    pro: true,
  },
  ...
  {
    title: 'Ask',
    subtitle: 'Tax questions, answered',
...
function MoreRow({ item, locked, onPress }: { item: Item; locked: boolean; onPress: () => void }) {
